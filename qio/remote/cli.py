...
from qio.device.monitor.command import (
    apply_project_monitor_options,
    device_monitor_cmd,
    get_project_options,
)
from qio.package.manager.core import inject_contrib_pysite
from qio.project.exception import NotPlatformIOProjectError
from qio.project.options import ProjectOptions
from qio.run.cli import cli as cmd_run
from qio.test.cli import cli as test_cmd
...
def remote_agent_start(name, share, working_dir):
    from qio.remote.client.agent_service import RemoteAgentService
...
def remote_agent_list():
    from qio.remote.client.agent_list import AgentListClient
...
def remote_update(agents, only_check, dry_run):
    from qio.remote.client.update_core import UpdateCoreClient
...
def remote_run(
    ...
    from qio.remote.client.run_or_test import RunOrTestClient
...
def device_list(agents, json_output):
    from qio.remote.client.device_list import DeviceListClient
...
def device_monitor(ctx, agents, **kwargs):
    from qio.remote.client.device_monitor import DeviceMonitorClient
