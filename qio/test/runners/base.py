...
from qio.exception import ReturnErrorCode
from qio.platform.factory import PlatformFactory
from qio.test.exception import UnitTestSuiteError
from qio.test.result import TestCase, TestStatus
from qio.test.runners.readers.program import ProgramTestOutputReader
from qio.test.runners.readers.serial import SerialTestOutputReader
...
class TestRunnerBase:
    ...
    def run_project_targets(self, targets):
        ...
        from qio.run.cli import cli as run_cmd
